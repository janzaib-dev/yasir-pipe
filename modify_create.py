...
with open('resources/views/admin_panel/product/create.blade.php', 'r', encoding='utf-8') as f:
    content = f.read()
...
new_js = """
            ...
            function generateRow(isBase = false) {
                ...
                tr.innerHTML = `
                    ...
                    <td><input type="number" step="0.01" class="form-control form-control-sm" name="packages[${rowCount}][weight]"></td>
                    <td><input type="number" step="0.01" class="form-control form-control-sm" name="packages[${rowCount}][height]"></td>
                    <td><input type="number" step="0.01" class="form-control form-control-sm" name="packages[${rowCount}][width]"></td>
                    <td><input type="number" step="0.01" class="form-control form-control-sm" name="packages[${rowCount}][length]"></td>
                    <td><input type="text" class="form-control form-control-sm" name="packages[${rowCount}][barcode]"></td>
                    <td><input type="number" step="0.000001" class="form-control form-control-sm row-cf" name="packages[${rowCount}][conversion_factor]" value="${isBase ? '1' : ''}" ${isBase ? 'readonly' : ''} required></td>
...
with open('resources/views/admin_panel/product/create.blade.php', 'w', encoding='utf-8') as f:
    f.write(content)
