        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function generateRow(pkg = null, isBase = false) {
                ...
                tr.innerHTML = `
                    ...
                    <td class="d-none"><input type="number" step="0.01" class="form-control form-control-sm" name="packages[${rowCount}][weight]" value="${pkg ? (pkg.weight||'') : ''}"></td>
                    <td class="d-none"><input type="number" step="0.01" class="form-control form-control-sm" name="packages[${rowCount}][height]" value="${pkg ? (pkg.height||'') : ''}"></td>
